// @ts-nocheck
import { Paper, Stack, Text, Grid, Group, ThemeIcon, Badge, useMantineColorScheme } from "@mantine/core";
import { 
  IconMapPin, 
  IconCompass, 
  IconMountain,
...
export default function LocationDisplay({ location }: LocationDisplayProps) {
  if (!location || !location.coordinate) {
    return (
      <Paper p="md" withBorder radius="md">
        <Text c="dimmed" ta="center">No location data available</Text>
      </Paper>
    );
  }
  ...
  const isParked = true; // Usually true if we have a static location
    ...
    <Paper p="md" withBorder radius="md">
      <Stack gap="md">
        <Group justify="space-between">
          <Text fw={600} size="lg">Vehicle Location</Text>
          ...
          <Grid.Col span={{ base: 12, sm: 6 }}>
            <Paper p="md" withBorder radius="sm">
              <Group gap="sm">
                ...
                <div>
                  <Text size="xs" c="dimmed">GPS Coordinates</Text>
                  <Text size="sm" fw={600}>{lat.toFixed(6)}, {lng.toFixed(6)}</Text>
                </div>
              </Group>
            </Paper>
          </Grid.Col>
            ...
            <Paper p="md" withBorder radius="sm" h="100%">
              <Stack gap="xs" align="center">
                ...
                <div className={styles.textCenter}>
                  ...
                  <Text size="lg" fw={700}>{compassDirection}</Text>
            ...
            <Paper p="md" withBorder radius="sm" h="100%">
              <Stack gap="xs" align="center">
                ...
                <div className={styles.textCenter}>
                  ...
                  <Text size="lg" fw={700}>{altitude || "--"}</Text>
                  <Text size="xs" c="dimmed">meters</Text>
                </div>
              </Stack>
            </Paper>
          </Grid.Col>
          ...
          <Paper p="sm" withBorder radius="sm">
            <Group justify="space-between">
              <Group gap="sm">
                ...
                <div>
                  <Text size="xs" c="dimmed">Current Speed</Text>
                  <Text size="sm" fw={600}>{speed} km/h</Text>
                </div>
              </Group>
            </Group>
          </Paper>
